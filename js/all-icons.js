...
for(i=0; i<icons.length; i++){
    icons[i].addEventListener('click', function(){
        var classlist=this.getElementsByClassName('wn')[0].classList,
            classname=this.getElementsByClassName('wn')[0].className,
        ...
        var content="<div class='wrapper-modal' data-selectable='true'>" + 
                        ...
                        "<footer class='footer-modal'>" +
                            "<pre><code class='html' id='selected-icon' data-selectable='true'>&lt;i class=\"" + classname + "\"&gt;&lt;/i&gt;</code></pre>" +
                        "</footer>" +
                    "</div>"
